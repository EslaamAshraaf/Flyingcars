...
class _HomeState extends State<Home> {
  ...
  List<Brand> fakeBrands = [
    Brand(name: 'Toyota', imagePath: 'Assets/images/toyota.png'),
    Brand(name: 'Honda', imagePath: 'Assets/images/honda.png'),
    Brand(name: 'Tesla', imagePath: 'Assets/images/tesla.png'),
    Brand(name: 'Audi', imagePath: 'Assets/images/audi.png'),
    Brand(name: 'BMW', imagePath: 'Assets/images/BMW.png'),
  ];
